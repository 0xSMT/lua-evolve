local foolish = {"sa", "foolish"}
local mutations = {"tbe", "pairwise"}

local prefix = "./output_sa/"
local prob_suffix = ".json_log.txt"

local problems = {"block12x12", "4x4", "5x5", "5x6"}
...
for _, prob in ipairs(problems) do
    ...
    for _, fool in ipairs(foolish) do
        for _, mut in ipairs(mutations) do
            ...
            for rep = 1, repetitions do
                local file_name = prefix .. fool .. "_" .. mut .. "_" .. prob .. "_" .. tostring(rep) .. prob_suffix
            ...
            print(fool .. "-" .. mut .. ":\t"..best..", "..sum_iter..", "..sum_fit..", "..sum_explored.."/"..state_space..", "..ideal)

            db[fool .. "_" .. mut .. "_" .. prob] = log
        end
    end
end